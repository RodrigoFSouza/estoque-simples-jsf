...
public class Empresa implements Serializable {
	...
	public void setDataFundacao(Date dataFuncadacao) {
		this.dataFundacao = dataFuncadacao;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(cnpj, dataFundacao, id, nomeFantasia, ramoAtividade, razaoSocial, tipo);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(cnpj, other.cnpj) && Objects.equals(dataFundacao, other.dataFundacao)
				&& Objects.equals(id, other.id) && Objects.equals(nomeFantasia, other.nomeFantasia)
